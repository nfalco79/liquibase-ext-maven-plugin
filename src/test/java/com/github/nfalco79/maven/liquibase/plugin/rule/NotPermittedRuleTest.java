...
public class NotPermittedRuleTest {

    @Test
    public void any_value_is_not_valid() throws Exception {
        IRule rule = new NotPermittedRule();
    ...
    public void verify_message() throws Exception {
        ...
        Assert.assertThat(rule.getMessage("field", "value"), equalTo("field is not allowed because is not portable"));
    }
